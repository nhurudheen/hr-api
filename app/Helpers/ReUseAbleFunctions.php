...
if (!function_exists('extractGenericId')) {
    function extractGenericId(?string $value = null, int $length = 10): string
    {
        if (!$value) {
...
if (!function_exists('generateCustomId')) {
     ...
     */
    function generateCustomId(string $input, int $stringLength): string
    {
